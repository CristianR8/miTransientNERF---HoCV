...
def load_args(eval = False, parser= None):
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.01,
        help="Optical-path length represented by one transient bin, in scene-distance units.",
    )
    parser.add_argument(
        "--start_opl",
        type=float,
        default=0.0,
        help="Optical-path length at transient bin zero, in scene-distance units.",
    )
    parser.add_argument(
        "--lr",
        type=float,
