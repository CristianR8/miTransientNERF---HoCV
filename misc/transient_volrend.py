...
def rendering_transient_single_path(
    ...
    if args.version == "simulated":
        ...
        bin_mapping, dist_weights = mapping_dist_to_bin_mitsuba(
            dists, args.n_bins, args.exposure_time, c=1, sigma=tfilter_sigma,
            start_opl=args.start_opl,
        )
        ...
        bin_numbers_floor, bin_numbers_ceil, alpha = mapping_dist_to_bin(
            dists, args.n_bins, args.exposure_time, start_opl=args.start_opl
        )
...
def mapping_dist_to_bin_mitsuba(dists, n_bins, exposure_time, c=1, sigma=5, start_opl=0.0):
    times = 2 * dists / c
    ratio = (times - start_opl) / exposure_time
...
def mapping_dist_to_bin(dists, n_bins, exposure_time, c=1, start_opl=0.0):
    times = 2 * dists / c
